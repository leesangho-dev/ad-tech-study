...
public class BoardController {
    ...
    public BoardController(SaveBoardItemUseCase saveBoardItemUseCase,
        FindBoardItemUseCase findBoardItemUseCase, DeleteBoardItemUseCase deleteBoardItemUseCase,
    ...
    public BaseResponse<BoardDto.ItemIdResponse> saveBoardItem(
    ...
    public BaseResponse<BoardDto.ItemIdResponse> updateBoardItem(
        ...
        BoardDto.ItemIdResponse itemIdResponse = updateBoardItemUseCase.execute(boardItemId,
            updateItemRequest);

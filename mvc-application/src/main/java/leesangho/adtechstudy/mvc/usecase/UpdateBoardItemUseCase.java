...
public class UpdateBoardItemUseCase {
  ...
  public UpdateBoardItemUseCase(BoardItemQueryService boardItemQueryService,
  ...
  public BoardDto.ItemIdResponse execute(String boardItemId,
      BoardDto.UpdateItemRequest updateItemRequest) {
